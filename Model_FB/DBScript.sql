...
DROP DOMAIN MON$SEC_DATABASE;

DROP DOMAIN SEC$KEY;

DROP DOMAIN SEC$NAME_PART;

DROP DOMAIN SEC$USER_NAME;

DROP DOMAIN SEC$VALUE;

CREATE DOMAIN D_BOOL AS 
BOOLEAN;

CREATE DOMAIN D_CHAR_1 AS 
CHAR(1);
...
CREATE DOMAIN D_NUMERIC_18_4 AS 
NUMERIC(18,4);

CREATE DOMAIN D_NUMERIC_5_2 AS 
NUMERIC(5,2);

CREATE DOMAIN D_STR_10 AS 
VARCHAR(10) CHARACTER SET WIN1251
COLLATE PXW_CYR;

CREATE DOMAIN D_STR_100 AS 
VARCHAR(100) CHARACTER SET WIN1251
COLLATE PXW_CYR;

CREATE DOMAIN D_STR_20 AS 
VARCHAR(20) CHARACTER SET WIN1251
COLLATE PXW_CYR;

CREATE DOMAIN D_STR_30 AS 
VARCHAR(30) CHARACTER SET WIN1251
COLLATE PXW_CYR;

CREATE DOMAIN D_STR_50 AS 
VARCHAR(50) CHARACTER SET WIN1251
COLLATE PXW_CYR;

CREATE TABLE ATTRSREF (
    ATTRID D_STR_20 NOT NULL,
    ATTRFULLNAME D_STR_100 NOT NULL,
    ATTRTYPE D_CHAR_1 NOT NULL);
...
CREATE TABLE BANKS (
    BANKID D_ID NOT NULL,
    BANKNAME D_STR_100 NOT NULL,
    BANKADDRESS D_STR_100,
    BIC D_STR_20);
...
CREATE TABLE BUDGETSKINDREF (
    BUDGETKINDID D_ID NOT NULL,
    BUDGETKINDNAME D_STR_50 NOT NULL);

DESCRIBE TABLE BUDGETSKINDREF
'Справочник видов финансирования';

CREATE TABLE CLIENTKINDSREF (
    CLIENTKINDID D_ID NOT NULL,
    CLIENTKINDNAME D_STR_100 NOT NULL);
...
CREATE TABLE CLIENTS (
    CLIENTID D_ID NOT NULL,
    CLIENTNAME D_STR_100 NOT NULL,
    CLIENTADDRESS D_STR_100,
    ACCOUNT D_STR_30,
    UNN D_STR_10,
    CLIENTKINDID D_CODE NOT NULL,
    MINISTRYID D_CODE,
    BUDGETKINDID D_CODE,
    BANKID D_CODE,
    ISDELETED D_BOOL DEFAULT FALSE);
...
CREATE TABLE COMMONSREF (
    COMMONID D_ID NOT NULL,
    COMMONNAME D_STR_100 NOT NULL,
    COMMONTABLENAME D_STR_50 NOT NULL);

DESCRIBE TABLE COMMONSREF
'Классификатор';

CREATE TABLE CONSUMERATTRS (
    CONSUMERATTRID D_ID NOT NULL,
    ATTRID D_CODE NOT NULL,
    CONSUMERID D_CODE NOT NULL,
    VALUEDATE D_DATE DEFAULT NOW NOT NULL,
    SVALUE D_STR_100,
    NVALUE D_NUMERIC_18_4,
    DVALUE D_DATE);
...
CREATE TABLE CONSUMERS (
    CONSUMERID D_ID NOT NULL,
    CONSUMERNAME D_STR_100 NOT NULL,
    CLIENTID D_CODE NOT NULL,
    ISHOUSINGSTOCK D_BOOL,
    LOCALITYID D_CODE);
...
CREATE TABLE CONSUMERSERVS (
    CONSUMERSERVID D_ID NOT NULL,
    CONSUMERID D_CODE NOT NULL,
    SERVID D_CODE NOT NULL,
    PRODUCTSITEID D_CODE NOT NULL,
    COUNTERID D_CODE,
    ISACTIVE D_BOOL DEFAULT TRUE);

DESCRIBE TABLE CONSUMERSERVS
'Виды услуг по потребителям';

CREATE TABLE COUNTERKINDSREF (
    COUNTERKINDID D_ID NOT NULL,
    COUNTERKINDNAME D_STR_50);

DESCRIBE TABLE COUNTERKINDSREF
'Справочник видов приборов учета';

CREATE TABLE COUNTERS (
    COUNTERID D_ID NOT NULL,
    COUNTERNAME D_STR_50,
    CLIENTID D_CODE,
    COUNTERKINDID D_CODE,
    ISGROUPCOUNTER D_BOOL);

DESCRIBE TABLE COUNTERS
'Приборы учета';

CREATE TABLE FUELNORMS (
    FUELNORMID D_ID NOT NULL,
    PRODUCTSITEID D_CODE NOT NULL,
    FUELID D_CODE NOT NULL,
    FUELNORMVAL D_NUMERIC_18_4);

DESCRIBE TABLE FUELNORMS
'Нормы расхода топлива';

CREATE TABLE FUELSREF (
    FUELID D_ID NOT NULL,
    FUELNAME D_STR_50 NOT NULL,
    CONVERTRATIO D_NUMERIC_18_4);

DESCRIBE TABLE FUELSREF
'Виды топлива';

CREATE TABLE HEATINGCHARACTERSREF (
    HEATCHARID D_ID NOT NULL,
    VOLUME_FROM D_CODE,
    VOLUME_TO D_CODE,
    Q_NEW_K D_NUMERIC_18_4,
    Q_NEW_D D_NUMERIC_18_4,
    Q_OLD_K D_NUMERIC_18_4,
    Q_OLD_D D_NUMERIC_18_4);

DESCRIBE TABLE HEATINGCHARACTERSREF
'Отопительные характеристики';

CREATE TABLE HOUSEATTRS (
    HOUSEATTRID D_ID NOT NULL,
    HOUSEID D_CODE NOT NULL,
    ATTRID D_CODE NOT NULL,
    VALUEDATE D_DATE NOT NULL,
    SVALUE D_STR_100,
    NVALUE D_NUMERIC_18_4,
    DVALUE D_DATE);
...
CREATE TABLE LOCALITIESREF (
    LOCALITYID D_ID NOT NULL,
    LOCALITYNAME D_STR_100 NOT NULL,
    LOCALITYCOUNCIL D_STR_100);
...
CREATE TABLE PRODUCTSITES (
    PRODUCTSITEID D_ID NOT NULL,
    PRODUCTSITENAME D_STR_50,
    LOCATIONTYPEID D_CODE,
    CHIEF D_STR_50,
    COUNTERID D_CODE);
...
CREATE TABLE SERVICEKINDSREF (
    SERVICEKINDID D_ID NOT NULL,
    SERVICEKINDNAME D_STR_100 NOT NULL);

DESCRIBE TABLE SERVICEKINDSREF
'Справочник видов услуг';

CREATE TABLE STREETSREF (
    STREETID D_ID NOT NULL,
    STREETNAME D_STR_100);

DESCRIBE TABLE STREETSREF
'Справочник улиц';

CREATE TABLE TARIFFSERVS (
    SERVID D_ID NOT NULL,
    SERVTITLE D_STR_50 NOT NULL,
    SERVICEKINDID D_CODE NOT NULL,
    VATID D_CODE);
...
CREATE TABLE TARIFFSERVSVAL (
    SERVID D_CODE NOT NULL,
    DATEFROM D_DATE NOT NULL,
    TARIFFVALUE D_NUMERIC_18_4 NOT NULL);
